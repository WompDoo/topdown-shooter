...
// Keyed by weapon name (unique across the roster). Every cell in this pack is
// drawn muzzle-west (barrel to the left, stock/grip to the right), so they all
// carry flip:true — the renderer mirrors them so the barrel follows the aim.
const ART: Record<string, WeaponArt> = {
  Sidearm: { sx: 48, sy: 144, sw: 14, sh: 7, flip: true },
  'Vector SMG': { sx: 96, sy: 144, sw: 25, sh: 12, flip: true },
  'MK-7 Carbine': { sx: 288, sy: 0, sw: 33, sh: 11, flip: true },
  'M60 HMG': { sx: 288, sy: 120, sw: 47, sh: 13, flip: true }, // c6r5 — bipod M60
  'Frag Grenade': { sx: 0, sy: 121, sw: 10, sh: 7, flip: true },
  ...
  'Combat Knife': { sx: 48, sy: 216, sw: 8, sh: 7, flip: true },
  'Raider Rifle': { sx: 192, sy: 72, sw: 34, sh: 10, flip: true },
  'Scrap Shotgun': { sx: 144, sy: 0, sw: 21, sh: 9, flip: true },
  'Machine Pistol': { sx: 96, sy: 72, sw: 19, sh: 14, flip: true },
  'Marksman Rifle': { sx: 288, sy: 144, sw: 44, sh: 12, flip: true },
};
